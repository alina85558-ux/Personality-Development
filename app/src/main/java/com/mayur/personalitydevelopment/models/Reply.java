...
public class Reply implements Comparable<Reply> {
    ...
    public int compareTo(Reply reply) {
        return reply.getmId() == this.mId ? 0 : 1;
    }
    ...
    public static class Builder {
        ...
        public Reply.Builder withSubject(String mSubject) {
            subject = mSubject;
            return this;
        }

        public Reply.Builder withParentId(String mParentId) {
            parentId = mParentId;
            return this;
        }

        public Reply.Builder withTotalLikes(String mTotalLikes) {
            totalLikes = mTotalLikes;
            return this;
        }

        public Reply.Builder withFirstName(String mFirstName) {
            firstName = mFirstName;
            return this;
        }

        public Reply.Builder withLastLame(String mLastLame) {
            lastLame = mLastLame;
            return this;
        }

        public Reply.Builder withProfilePhotoThumb(String mProfilePhotoThumb) {
            profilePhotoThumb = mProfilePhotoThumb;
            return this;
        }

        public Reply.Builder withCanDelete(boolean mCanDelete) {
            canDelete = mCanDelete;
            return this;
        }

        public Reply.Builder withCommentText(String commentText) {
            mCommentText = commentText;
            return this;
        }

        public Reply.Builder withCommentUserId(int commentUserId) {
            mCommentUserId = commentUserId;
            return this;
        }

        public Reply.Builder withId(int id) {
            mId = id;
            return this;
        }

        public Reply.Builder withLikedByMe(boolean likedByMe) {
            mLikedByMe = likedByMe;
            return this;
        }

        public Reply.Builder withReplies(ArrayList<Reply> replies) {
            mReplies = replies;
            return this;
        }

        public Reply.Builder withTime(long createdAt) {
            mCreatedAt = createdAt;
            return this;
        }

        public Reply.Builder withTimestamp(String timestamp) {
        ...
        public Reply build() {
            ...
            reply.lastLame = lastLame;
            reply.profilePhotoThumb = profilePhotoThumb;
            reply.canDelete = canDelete;
            reply.mCommentText = mCommentText;
            reply.mCommentUserId = mCommentUserId;
            reply.mId = mId;
            reply.mLikedByMe = mLikedByMe;
            reply.mReplies = mReplies;
            reply.mCreatedAt = mCreatedAt;
            reply.mTimestamp = mTimestamp;
            return reply;
        }
